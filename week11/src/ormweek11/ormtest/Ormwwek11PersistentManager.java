...
public class Ormwwek11PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ormwwek11";
	...
	private Ormwwek11PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Ormwwek11PersistentManager();
		}
